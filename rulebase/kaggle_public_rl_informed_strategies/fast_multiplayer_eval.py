"""Parallel 4-player evaluator backed by the fast Orbit Wars simulator."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--opponents",
        nargs=3,
        choices=sorted(CHAMPION_OPPONENT_VARIANTS),
...
def main(
    ...
    json_path = OUT_DIR / f"{suite}_fast_4p_ablation_{stamp}_{opponent_tag}.json"
    csv_path = OUT_DIR / f"{suite}_fast_4p_ablation_{stamp}_{opponent_tag}.csv"
    payload = {
