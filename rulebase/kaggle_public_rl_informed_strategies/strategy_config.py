...
class StrategyConfig:
    ...
    enable_contested_stop_loss: bool = False
    contested_stop_loss_min_active_players: int = 0
    contested_stop_loss_max_active_players: int = 99
    contested_stop_loss_window: int = 40
    contested_stop_loss_flip_threshold: int = 3
    contested_stop_loss_low_prod_max: float = 2.0
    contested_stop_loss_high_prod_exception_min: float = 3.0
    ...
    enable_enemy_wave_preserve_prod: bool = False
    enemy_wave_preserve_min_active_players: int = 0
    enemy_wave_preserve_max_active_players: int = 99
    enemy_wave_preserve_min_step: int = 0
    enemy_wave_preserve_max_step: int = 180
    enemy_wave_preserve_min_production: float = 4.0
    enemy_wave_preserve_horizon: int = 40
    enemy_wave_preserve_min_enemy_post_capture: int = 30
    enemy_wave_preserve_margin: int = 10
    enemy_wave_preserve_min_send: int = 10
    enemy_wave_preserve_max_send: int = 48
    enemy_wave_preserve_max_sources: int = 2
    enemy_wave_preserve_max_targets: int = 1
    enemy_wave_preserve_source_min_after: int = 6
    enemy_wave_preserve_source_prod_turns_after: int = 1
    enable_doomed_planet_evacuation: bool = False
    doomed_evac_min_active_players: int = 0
    doomed_evac_max_active_players: int = 99
    doomed_evac_min_step: int = 0
    doomed_evac_max_step: int = 220
    doomed_evac_min_production: float = 1.0
    doomed_evac_horizon: int = 24
    doomed_evac_min_arrival: int = 1
    doomed_evac_max_arrival: int = 8
    doomed_evac_min_enemy_post_capture: int = 3
    doomed_evac_keep_ships: int = 0
    doomed_evac_min_send: int = 6
    doomed_evac_max_send: int = 80
    doomed_evac_max_sources: int = 2
    doomed_evac_allow_own_target: bool = True
    doomed_evac_allow_attack_target: bool = True
    doomed_evac_own_target_bonus: float = 20.0
    doomed_evac_attack_target_bonus: float = 8.0
    doomed_evac_target_prod_weight: float = 8.0
    doomed_evac_enemy_target_bonus: float = 18.0
    doomed_evac_attack_max_arrival: int = 999
    doomed_evac_attack_min_production: float = 0.0
    doomed_evac_attack_enemy_only: bool = False
    doomed_evac_attack_min_net_value: float = -999.0
    doomed_evac_attack_source_only: bool = False
    ...
    dynamic_recapture_enable_4p_collapse: bool = False
    dynamic_recapture_collapse_loss_count: int = 2
    dynamic_recapture_collapse_window: int = 20
    dynamic_recapture_enable_front_base: bool = False
    dynamic_recapture_front_own_radius: float = 45.0
    dynamic_recapture_front_min_own_neighbors: int = 2
    dynamic_recapture_anchor_window: int = 35
    dynamic_recapture_anchor_min_production: float = 4.0
    dynamic_recapture_anchor_radius: float = 55.0
    ...
    enable_no_attack_fallback: bool = False
    no_attack_fallback_min_active_players: int = 0
    no_attack_fallback_max_active_players: int = 99
    no_attack_fallback_min_step: int = 0
    no_attack_fallback_max_step: int = 500
    no_attack_fallback_candidate_limit: int = 5
    no_attack_fallback_min_attack_delta: int = 0
    enable_opening_tempo_neutral_fallback: bool = False
    opening_tempo_min_active_players: int = 0
    opening_tempo_max_active_players: int = 99
    opening_tempo_step_limit: int = 50
    opening_tempo_min_production: float = 3.0
    opening_tempo_max_target_ships: int = 24
    opening_tempo_max_eta: int = 35
    ...
    enable_recent_capture_activation: bool = False
    activation_enable_extra_attack: bool = True
    activation_enable_attack_priority: bool = False
    activation_enable_trickle: bool = False
    activation_attack_source_bonus: float = 800.0
    activation_attack_target_bonus: float = 45.0
    activation_trickle_min_send: int = 8
    activation_trickle_max_send: int = 28
    activation_trickle_send_fraction: float = 0.75
    activation_min_prod_diff: float = -999.0
    activation_min_ship_diff: float = -99999.0
    activation_min_planet_diff: int = -999
    activation_max_recent_highprod_losses: int = 999
    activation_min_active_players: int = 2
    activation_max_active_players: int = 2
    activation_min_step: int = 0
    activation_max_step: int = 140
    activation_source_window: int = 24
    activation_source_min_production: float = 3.0
    activation_enable_front_base_source: bool = False
    activation_front_base_max_production: float = 2.0
    activation_front_base_enemy_radius: float = 42.0
    activation_source_min_after: int = 5
    activation_source_prod_turns_after: int = 1
    activation_min_send: int = 8
    activation_max_send: int = 48
    activation_target_min_production: float = 2.0
    activation_include_neutral_targets: bool = True
    activation_include_enemy_targets: bool = True
    activation_allow_moving_sources: bool = True
    activation_allow_static_sources: bool = True
    activation_allow_moving_targets: bool = True
    activation_allow_static_targets: bool = True
    activation_source_front_enemy_radius: float = 0.0
    activation_source_support_radius: float = 0.0
    activation_source_min_support_prod: float = 0.0
    activation_target_front_own_radius: float = 0.0
    activation_target_front_enemy_radius: float = 0.0
    ...
    activation_base_target_score_weight: float = 0.25
    activation_enemy_bonus: float = 36.0
    activation_neutral_bonus: float = 18.0
    activation_prod_weight: float = 12.0
    activation_eta_weight: float = 0.75
    activation_ship_weight: float = 0.20
    activation_direction_bonus: float = 12.0
    activation_front_base_target_bonus: float = 10.0
    ...
    mobile_relay_min_step: int = 0
    mobile_relay_max_step: int = 140
    mobile_relay_max_ships: int = 18
    mobile_relay_min_production: float = 1.0
    mobile_relay_goal_min_production: float = 4.0
    mobile_relay_direct_min_eta: int = 45
    mobile_relay_max_first_eta: int = 30
    mobile_relay_max_second_eta: int = 35
    mobile_relay_min_eta_savings: int = 10
    mobile_relay_bonus: float = 55.0
    mobile_relay_comet_min_remaining: int = 45
    mobile_relay_recent_source_window: int = 45
    mobile_relay_source_order_bonus: float = 900.0
    mobile_relay_source_target_bonus: float = 55.0
    enable_recent_high_prod_hub_support: bool = False
    hub_support_min_active_players: int = 0
    hub_support_max_active_players: int = 99
    hub_support_min_step: int = 0
    hub_support_max_step: int = 120
    hub_support_recent_capture_window: int = 24
    hub_support_min_production: float = 3.0
    hub_support_enemy_radius: float = 55.0
    hub_support_base_margin: int = 6
    hub_support_prod_turns: int = 3
    hub_support_front_bonus: int = 6
    hub_support_max_eta: int = 28
    hub_support_min_send: int = 6
    hub_support_max_send: int = 32
    hub_support_source_min_after: int = 6
    hub_support_source_prod_turns_after: int = 1
    hub_support_max_targets: int = 1
...
TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_CANDIDATE_CONFIG = (
    TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_REGULAR_CONFIG
)
TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_P4MIDBORDER_S40_REGULAR_CONFIG = StrategyConfig(
    **{
        **TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_REGULAR_CONFIG.to_agent_kwargs(),
...
TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_P4MIDBORDER_S40_P4CHAIN_SRC4_REGULAR_CONFIG = StrategyConfig(
    **{
        **TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_P4MIDBORDER_S40_REGULAR_CONFIG.to_agent_kwargs(),
        ...
        "chain_attack_neutral_bonus": 15.0,
    }
)
TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_P4MIDBORDER_S40_P4CHAIN_SRC4_P4MOBILEBASE_REGULAR_CONFIG = StrategyConfig(
    **{
        **TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_P4MIDBORDER_S40_P4CHAIN_SRC4_REGULAR_CONFIG.to_agent_kwargs(),
...
HISTORICAL_BEST_VARIANTS = {
    ...
    "orbit_wars_regular_p4src_w002_lead10_p4earlysrc_s35_80_t120_tail_m2_max14_net7_overpay4_p4lowhome_active4_p2trickle_s30_slim_20260519": TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_REGULAR_CONFIG.to_agent_kwargs(),
    "orbit_wars_regular_p4src_w002_lead10_p4earlysrc_s35_80_t120_tail_m2_max14_net7_overpay4_p4lowhome_active4_p2trickle_s30_p4midborder_s40_slim_20260519": TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_P4MIDBORDER_S40_REGULAR_CONFIG.to_agent_kwargs(),
...
ABLATION_SUITES["myreplay_plan021_p2_low_home_trickle_confirm"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p2_low_home_trickle_s30_src1_tgt4_m5": ABLATION_SUITES[
        "myreplay_plan018_p2_low_home_expansion_focus"
    ]["p2_low_home_trickle_s30_src1_tgt4_m5"],
    "p2_low_home_trickle_s40_src1_tgt3_m5": ABLATION_SUITES[
        "myreplay_plan018_p2_low_home_expansion_focus"
    ]["p2_low_home_trickle_s40_src1_tgt3_m5"],
}

ABLATION_SUITES["myreplay_plan022_p2_trickle_highprod_combo"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p2_trickle_s30": TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_CANDIDATE_CONFIG.to_agent_kwargs(),
    "p2_trickle_s30_send_filter_s45_115_m6": from_base(
        TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_CANDIDATE_CONFIG,
        enable_source_threat_send_filter=True,
        source_threat_send_min_active_players=2,
        source_threat_send_max_active_players=2,
    ...
    "p2_trickle_s30_recent_reserve_s45_150_m6": from_base(
        TAIL_M2_MAX14_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P2TRICKLE_S30_CANDIDATE_CONFIG,
        enable_recent_capture_source_reserve=True,
        recent_capture_source_reserve_min_active_players=2,
        recent_capture_source_reserve_min_step=45,
...
ABLATION_SUITES["myreplay_plan023_p2_frontbase_recap_breadth"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p2_recap_prod2_b30": from_base(
        REGULAR_CONFIG,
        recent_loss_recapture_min_production=2.0,
        recent_loss_recapture_bonus=30.0,
        recent_loss_recapture_window=55,
    ),
    "p2_recap_prod1_b24": from_base(
        REGULAR_CONFIG,
        recent_loss_recapture_min_production=1.0,
        recent_loss_recapture_bonus=24.0,
        recent_loss_recapture_window=45,
    ),
    "p2_candidate_limit3": from_base(
        REGULAR_CONFIG,
        target_candidate_limit=3,
    ),
    "p2_front_support_soft": from_base(
        REGULAR_CONFIG,
        enable_front_support=True,
        support_distance_factor=1.20,
        support_min_available=16,
        support_fraction=0.55,
        support_min_send=8,
        support_max_arrival=38,
    ),
    "p2_recap_prod2_candidate3": from_base(
        REGULAR_CONFIG,
        recent_loss_recapture_min_production=2.0,
        recent_loss_recapture_bonus=30.0,
        recent_loss_recapture_window=55,
...
ABLATION_SUITES["myreplay_plan024_p4_pinch_front_defense"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_local_reserve_s30_130_p3": from_base(
        REGULAR_CONFIG,
        enable_local_source_reserve=True,
        local_reserve_min_step=30,
        local_reserve_max_step=130,
        local_reserve_min_production=3.0,
        local_reserve_enemy_distance=48.0,
        local_reserve_turns=2,
        local_reserve_min_garrison=7,
        local_reserve_front_bonus=8,
    ),
    "p4_proactive_recent_p3_s55_150": from_base(
        REGULAR_CONFIG,
        enable_proactive_value_defense=True,
        proactive_defense_min_active_players=4,
        proactive_defense_max_active_players=4,
        ...
        proactive_defense_max_step=150,
    ...
    "p4_front_support_soft": from_base(
        REGULAR_CONFIG,
        enable_front_support=True,
        support_distance_factor=1.25,
        support_min_available=18,
        support_fraction=0.55,
        support_min_send=8,
        support_max_arrival=35,
    ),
    "p4_local_reserve_plus_front_support": from_base(
        REGULAR_CONFIG,
        enable_local_source_reserve=True,
        local_reserve_min_step=30,
        local_reserve_max_step=130,
...
ABLATION_SUITES["myreplay_plan025_p2_action_breadth_global"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p2_candidate_limit4": from_base(
        REGULAR_CONFIG,
        target_candidate_limit=4,
    ),
    "p2_min_attack9": from_base(
        REGULAR_CONFIG,
        min_ships_mine_attack=9,
    ),
    "p2_global_priority_soft": from_base(
        REGULAR_CONFIG,
        enable_global_attack_priority=True,
        global_attack_max_failed_pairs=128,
        global_attack_roi_weight=0.02,
        global_attack_arrival_penalty=0.15,
    ),
    "p2_min9_candidate4": from_base(
        REGULAR_CONFIG,
        min_ships_mine_attack=9,
        target_candidate_limit=4,
    ),
    "p2_min9_global_priority": from_base(
        REGULAR_CONFIG,
        min_ships_mine_attack=9,
        enable_global_attack_priority=True,
        global_attack_max_failed_pairs=128,
...
ABLATION_SUITES["myreplay_plan029_p2_no_attack_fallback"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p2_no_attack_fallback_c5": from_base(
        REGULAR_CONFIG,
    ...
    "p2_no_attack_fallback_c6_min11": from_base(
        REGULAR_CONFIG,
        enable_no_attack_fallback=True,
        no_attack_fallback_min_active_players=2,
        no_attack_fallback_max_active_players=2,
        no_attack_fallback_candidate_limit=6,
        no_attack_fallback_min_attack_delta=-1,
    ),
    "p2_no_attack_fallback_c8_min10": from_base(
        REGULAR_CONFIG,
        enable_no_attack_fallback=True,
        no_attack_fallback_min_active_players=2,
        no_attack_fallback_max_active_players=2,
        no_attack_fallback_candidate_limit=8,
...
ABLATION_SUITES["vadasz_plan001_opening_tempo_neutral"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_tempo_prod3_s50_ship24_eta35_after5": from_base(
        REGULAR_CONFIG,
        ...
        opening_tempo_max_eta=35,
        opening_tempo_source_min_production=1.0,
        opening_tempo_source_min_after=5,
        opening_tempo_candidate_limit=6,
    ),
    "p4_tempo_prod3_s45_ship20_eta30_after6": from_base(
        REGULAR_CONFIG,
        enable_opening_tempo_neutral_fallback=True,
        opening_tempo_min_active_players=4,
        opening_tempo_max_active_players=4,
...
ABLATION_SUITES["vadasz_plan002_candidate_breadth"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "candidate_limit3": from_base(
        REGULAR_CONFIG,
        target_candidate_limit=3,
    ),
    "candidate_limit4": from_base(
        REGULAR_CONFIG,
        target_candidate_limit=4,
    ),
    "global_priority_light": from_base(
        REGULAR_CONFIG,
        enable_global_attack_priority=True,
        global_attack_max_failed_pairs=96,
        global_attack_roi_weight=0.01,
        global_attack_arrival_penalty=0.10,
    ),
    "global_priority_roi": from_base(
        REGULAR_CONFIG,
        enable_global_attack_priority=True,
        global_attack_max_failed_pairs=128,
        global_attack_roi_weight=0.02,
...
ABLATION_SUITES["vadasz_plan003_key_star_hold"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "urgent_value_h18_m10_send32": from_base(
        REGULAR_CONFIG,
        enable_value_defense=True,
        value_defense_min_production=4.0,
        value_defense_horizon=18,
        value_defense_buffer_turns=2,
        value_defense_min_margin=10,
        value_defense_max_send=32,
        value_defense_roi_multiplier=1.10,
        value_defense_multiplayer_min_active_players=4,
        value_defense_multiplayer_horizon=18,
        value_defense_multiplayer_max_send=32,
        value_defense_multiplayer_min_margin=10,
    ),
    "urgent_value_h12_m8_send24": from_base(
        REGULAR_CONFIG,
        enable_value_defense=True,
        value_defense_min_production=4.0,
        value_defense_horizon=12,
        value_defense_buffer_turns=1,
        value_defense_min_margin=8,
        value_defense_max_send=24,
        value_defense_roi_multiplier=1.05,
        value_defense_multiplayer_min_active_players=4,
        value_defense_multiplayer_horizon=12,
        value_defense_multiplayer_max_send=24,
        value_defense_multiplayer_min_margin=8,
    ),
    "recapture_hold_prod4_w60_m10": from_base(
        REGULAR_CONFIG,
        enable_recent_loss_recapture_hold_gate=True,
        recent_loss_recapture_hold_min_active_players=4,
        recent_loss_recapture_hold_min_step=35,
        recent_loss_recapture_hold_max_step=180,
        recent_loss_recapture_hold_window=60,
        recent_loss_recapture_hold_min_production=4.0,
        recent_loss_recapture_hold_enemy_radius=45.0,
        recent_loss_recapture_hold_margin=10,
        recent_loss_recapture_hold_allow_extra_send=True,
    ),
    "urgent_value_plus_recapture_hold": from_base(
        REGULAR_CONFIG,
        enable_value_defense=True,
        value_defense_min_production=4.0,
        value_defense_horizon=18,
...
ABLATION_SUITES["vadasz_plan004_high_prod_hub_support"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_hub_prod3_w24_eta28_m6_send32": from_base(
        REGULAR_CONFIG,
        enable_recent_high_prod_hub_support=True,
        hub_support_min_active_players=4,
        hub_support_max_active_players=4,
        hub_support_max_step=100,
        hub_support_recent_capture_window=24,
        hub_support_min_production=3.0,
        hub_support_enemy_radius=55.0,
        hub_support_base_margin=6,
        hub_support_prod_turns=3,
        hub_support_front_bonus=6,
        hub_support_max_eta=28,
        hub_support_min_send=6,
        hub_support_max_send=32,
        hub_support_source_min_after=6,
        hub_support_source_prod_turns_after=1,
        hub_support_max_targets=1,
    ),
    "p4_hub_prod4_w30_eta30_m8_send36": from_base(
        REGULAR_CONFIG,
        enable_recent_high_prod_hub_support=True,
        hub_support_min_active_players=4,
        hub_support_max_active_players=4,
        ...
        hub_support_min_production=4.0,
        hub_support_enemy_radius=60.0,
        hub_support_base_margin=8,
        hub_support_prod_turns=3,
        hub_support_front_bonus=8,
        hub_support_max_eta=30,
        hub_support_min_send=8,
        hub_support_max_send=36,
        hub_support_source_min_after=7,
        hub_support_source_prod_turns_after=1,
        hub_support_max_targets=1,
    ),
    "p2_hub_prod3_w24_eta28_m6_send28": from_base(
        REGULAR_CONFIG,
        enable_recent_high_prod_hub_support=True,
...
ABLATION_SUITES["vadasz_plan005_enemy_wave_preserve_prod"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_wave_prod4_h35_post30_m10_send48_src2": from_base(
        REGULAR_CONFIG,
        ...
        enemy_wave_preserve_max_step=170,
        enemy_wave_preserve_min_production=4.0,
        enemy_wave_preserve_horizon=35,
        enemy_wave_preserve_min_enemy_post_capture=30,
        enemy_wave_preserve_margin=10,
        enemy_wave_preserve_min_send=10,
        enemy_wave_preserve_max_send=48,
        enemy_wave_preserve_max_sources=2,
        enemy_wave_preserve_max_targets=1,
        enemy_wave_preserve_source_min_after=6,
        enemy_wave_preserve_source_prod_turns_after=1,
    ),
    "p4_wave_prod4_h45_post45_m12_send56_src2": from_base(
        REGULAR_CONFIG,
        enable_enemy_wave_preserve_prod=True,
        enemy_wave_preserve_min_active_players=4,
        enemy_wave_preserve_max_active_players=4,
        enemy_wave_preserve_min_step=40,
        enemy_wave_preserve_max_step=180,
        enemy_wave_preserve_min_production=4.0,
        enemy_wave_preserve_horizon=45,
        enemy_wave_preserve_min_enemy_post_capture=45,
        enemy_wave_preserve_margin=12,
        enemy_wave_preserve_min_send=12,
        enemy_wave_preserve_max_send=56,
        enemy_wave_preserve_max_sources=2,
        enemy_wave_preserve_max_targets=1,
        enemy_wave_preserve_source_min_after=7,
        enemy_wave_preserve_source_prod_turns_after=1,
    ),
    "p2_wave_prod3_h40_post45_m12_send56_src2": from_base(
        REGULAR_CONFIG,
        enable_enemy_wave_preserve_prod=True,
        enemy_wave_preserve_min_active_players=2,
        enemy_wave_preserve_max_active_players=2,
        enemy_wave_preserve_min_step=45,
        enemy_wave_preserve_max_step=220,
        enemy_wave_preserve_min_production=3.0,
    ...
    "p2_wave_prod4_h45_post60_m14_send64_src2": from_base(
        REGULAR_CONFIG,
        enable_enemy_wave_preserve_prod=True,
        enemy_wave_preserve_min_active_players=2,
        enemy_wave_preserve_max_active_players=2,
        enemy_wave_preserve_min_step=60,
        enemy_wave_preserve_max_step=240,
        enemy_wave_preserve_min_production=4.0,
        enemy_wave_preserve_horizon=45,
        enemy_wave_preserve_min_enemy_post_capture=60,
        enemy_wave_preserve_margin=14,
        enemy_wave_preserve_min_send=14,
        enemy_wave_preserve_max_send=64,
        enemy_wave_preserve_max_sources=2,
        enemy_wave_preserve_max_targets=1,
        enemy_wave_preserve_source_min_after=8,
        enemy_wave_preserve_source_prod_turns_after=1,
    ),
}

ABLATION_SUITES["vadasz_plan006_dynamic_front_base_recapture"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p2_dynamic_recap_p2_w45_b25_pw4": from_base(
        REGULAR_CONFIG,
        enable_dynamic_front_base_recapture=True,
        dynamic_recapture_min_production=2.0,
        dynamic_recapture_enable_2p=True,
        dynamic_recapture_enable_4p_collapse=False,
        dynamic_recapture_enable_front_base=False,
        recent_loss_recapture_window=45,
        recent_loss_recapture_bonus=25.0,
        recent_loss_recapture_prod_weight=4.0,
    ),
    "p2_dynamic_recap_p2_w50_b35_pw5": from_base(
        REGULAR_CONFIG,
        enable_dynamic_front_base_recapture=True,
        dynamic_recapture_min_production=2.0,
        dynamic_recapture_enable_2p=True,
        ...
        recent_loss_recapture_window=50,
        recent_loss_recapture_bonus=35.0,
        recent_loss_recapture_prod_weight=5.0,
    ),
    "p4_collapse_recap_p2_loss2w20": from_base(
        REGULAR_CONFIG,
        enable_dynamic_front_base_recapture=True,
        dynamic_recapture_min_production=2.0,
        dynamic_recapture_enable_2p=False,
        dynamic_recapture_enable_4p_collapse=True,
        dynamic_recapture_collapse_loss_count=2,
        dynamic_recapture_collapse_window=20,
        dynamic_recapture_enable_front_base=False,
    ),
    "p2_or_p4_collapse_recap_p2": from_base(
        REGULAR_CONFIG,
        enable_dynamic_front_base_recapture=True,
        dynamic_recapture_min_production=2.0,
        dynamic_recapture_enable_2p=True,
    ...
    "frontbase_recap_p2_near2own45": from_base(
        REGULAR_CONFIG,
        enable_dynamic_front_base_recapture=True,
        dynamic_recapture_min_production=2.0,
        dynamic_recapture_enable_2p=False,
        dynamic_recapture_enable_4p_collapse=False,
        dynamic_recapture_enable_front_base=True,
        dynamic_recapture_front_own_radius=45.0,
        dynamic_recapture_front_min_own_neighbors=2,
        dynamic_recapture_anchor_window=35,
        dynamic_recapture_anchor_min_production=4.0,
        dynamic_recapture_anchor_radius=55.0,
    ),
}

ABLATION_SUITES["vadasz_plan007_recent_capture_chain_attack"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_chain_srcp3_tgtp3_w24_eta28_enemy45_neu20": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_chain_attack=True,
        chain_attack_min_active_players=4,
        chain_attack_max_active_players=4,
    ...
    "p4_chain_enemy_only_srcp3_tgtp3_w24_eta24_b60": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_chain_attack=True,
        chain_attack_min_active_players=4,
        chain_attack_max_active_players=4,
        chain_attack_min_step=10,
        chain_attack_max_step=120,
        chain_attack_source_window=24,
        chain_attack_source_min_production=3.0,
        chain_attack_target_min_production=3.0,
        ...
        chain_attack_source_order_bonus=1000.0,
        chain_attack_enemy_bonus=60.0,
        chain_attack_neutral_bonus=0.0,
    ),
    "p4_chain_srcp4_tgtp3_w30_eta30_enemy55_neu15": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_chain_attack=True,
        chain_attack_min_active_players=4,
        chain_attack_max_active_players=4,
    ...
    "p2_chain_srcp3_tgtp4_w20_eta24_enemy40_neu10": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_chain_attack=True,
        chain_attack_min_active_players=2,
        chain_attack_max_active_players=2,
        chain_attack_min_step=0,
        chain_attack_max_step=110,
        chain_attack_source_window=20,
        chain_attack_source_min_production=3.0,
        chain_attack_target_min_production=4.0,
        chain_attack_max_eta=24,
        chain_attack_source_order_bonus=1000.0,
        chain_attack_enemy_bonus=40.0,
        chain_attack_neutral_bonus=10.0,
    ),
    "all_chain_srcp3_tgtp3_w20_eta22_enemy35_neu10": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_chain_attack=True,
        chain_attack_min_active_players=0,
        chain_attack_max_active_players=99,
        chain_attack_min_step=0,
        chain_attack_max_step=110,
        chain_attack_source_window=20,
        chain_attack_source_min_production=3.0,
        ...
        chain_attack_source_order_bonus=1000.0,
        chain_attack_enemy_bonus=35.0,
        chain_attack_neutral_bonus=10.0,
    ),
}

ABLATION_SUITES["vadasz_plan007_recent_capture_chain_attack_focus"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_chain_srcp4_tgtp3_w30_eta30_enemy55_neu15": ABLATION_SUITES[
        "vadasz_plan007_recent_capture_chain_attack"
    ]["p4_chain_srcp4_tgtp3_w30_eta30_enemy55_neu15"],
}

ABLATION_SUITES["vadasz_plan008_contested_stop_loss"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_stoploss_prod2_w40_f3_p35_hold8": from_base(
        REGULAR_CONFIG,
        enable_contested_stop_loss=True,
    ...
    "p4_stoploss_prod2_w45_f3_p50_hold10": from_base(
        REGULAR_CONFIG,
        enable_contested_stop_loss=True,
        contested_stop_loss_min_active_players=4,
        contested_stop_loss_max_active_players=4,
        ...
        contested_stop_loss_low_prod_max=2.0,
        contested_stop_loss_high_prod_exception_min=3.0,
        contested_stop_loss_penalty=50.0,
        contested_stop_loss_min_hold=10,
        contested_stop_loss_prod_hold_turns=4,
    ),
    "p4_stoploss_prod1_w40_f3_p50_hold8": from_base(
        REGULAR_CONFIG,
        enable_contested_stop_loss=True,
        contested_stop_loss_min_active_players=4,
        contested_stop_loss_max_active_players=4,
    ...
    "all_stoploss_prod1_w40_f3_p35_hold8": from_base(
        REGULAR_CONFIG,
        enable_contested_stop_loss=True,
        contested_stop_loss_min_active_players=0,
        contested_stop_loss_max_active_players=99,
        contested_stop_loss_window=40,
        contested_stop_loss_flip_threshold=3,
        contested_stop_loss_low_prod_max=1.0,
        contested_stop_loss_high_prod_exception_min=3.0,
...
ABLATION_SUITES["vadasz_plan009_mobile_relay_attack"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_mobile_relay_prod4_direct45_saving10": from_base(
        REGULAR_CONFIG,
        enable_mobile_relay_attack=True,
        mobile_relay_min_active_players=4,
        mobile_relay_max_active_players=4,
        ...
        mobile_relay_goal_min_production=4.0,
        mobile_relay_direct_min_eta=45,
        mobile_relay_max_first_eta=30,
        mobile_relay_max_second_eta=35,
        mobile_relay_min_eta_savings=10,
        mobile_relay_bonus=55.0,
    ...
    "p4_mobile_relay_prod4_direct55_saving14": from_base(
        REGULAR_CONFIG,
        enable_mobile_relay_attack=True,
        mobile_relay_min_active_players=4,
        mobile_relay_max_active_players=4,
    ...
    "p4_mobile_relay_prod5_direct50_saving10": from_base(
        REGULAR_CONFIG,
        enable_mobile_relay_attack=True,
        mobile_relay_min_active_players=4,
        mobile_relay_max_active_players=4,
        mobile_relay_min_step=10,
        mobile_relay_max_step=160,
        mobile_relay_max_ships=20,
        mobile_relay_min_production=1.0,
        mobile_relay_goal_min_production=5.0,
        mobile_relay_direct_min_eta=50,
        mobile_relay_max_first_eta=32,
        mobile_relay_max_second_eta=35,
        mobile_relay_min_eta_savings=10,
        mobile_relay_bonus=70.0,
        mobile_relay_comet_min_remaining=50,
        mobile_relay_recent_source_window=50,
        mobile_relay_source_order_bonus=900.0,
        mobile_relay_source_target_bonus=70.0,
    ),
    "all_mobile_relay_prod4_direct55_saving14": from_base(
        REGULAR_CONFIG,
        enable_mobile_relay_attack=True,
        mobile_relay_min_active_players=0,
        mobile_relay_max_active_players=99,
        mobile_relay_min_step=0,
        mobile_relay_max_step=150,
        mobile_relay_max_ships=16,
        mobile_relay_min_production=1.0,
...
ABLATION_SUITES["vadasz_plan010_mobile_highprod_forward_base"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_mobile_base_prod3_goal3_loose": from_base(
        REGULAR_CONFIG,
        enable_mobile_relay_attack=True,
        mobile_relay_min_active_players=4,
        mobile_relay_max_active_players=4,
    ...
    "p4_mobile_base_prod4_goal3_loose": from_base(
        ...
        mobile_relay_max_second_eta=45,
        mobile_relay_min_eta_savings=-20,
        mobile_relay_bonus=45.0,
        mobile_relay_comet_min_remaining=55,
        mobile_relay_recent_source_window=50,
        mobile_relay_source_order_bonus=850.0,
        mobile_relay_source_target_bonus=45.0,
    ),
    "p4_mobile_base_prod3_goal4_moderate": from_base(
        REGULAR_CONFIG,
        enable_mobile_relay_attack=True,
        mobile_relay_min_active_players=4,
        mobile_relay_max_active_players=4,
        ...
        mobile_relay_min_production=3.0,
        mobile_relay_goal_min_production=4.0,
        mobile_relay_direct_min_eta=15,
        mobile_relay_max_first_eta=32,
        mobile_relay_max_second_eta=40,
        mobile_relay_min_eta_savings=-10,
        mobile_relay_bonus=45.0,
    ...
    "p4_mobile_base_prod4_goal4_moderate": from_base(
        REGULAR_CONFIG,
        enable_mobile_relay_attack=True,
        mobile_relay_min_active_players=4,
        mobile_relay_max_active_players=4,
...
ABLATION_SUITES["vadasz_plan010_mobile_highprod_forward_base_focus"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_mobile_base_prod4_goal4_moderate": ABLATION_SUITES[
        "vadasz_plan010_mobile_highprod_forward_base"
...
ABLATION_SUITES["myreplay_plan027_doomed_planet_evacuation"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p2_doomed_evac_safe_s0_180_eta8": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=2,
        doomed_evac_max_active_players=2,
        doomed_evac_min_step=0,
        doomed_evac_max_step=180,
        doomed_evac_min_production=1.0,
        doomed_evac_horizon=28,
        doomed_evac_max_arrival=8,
        doomed_evac_min_enemy_post_capture=4,
        doomed_evac_min_send=6,
        doomed_evac_max_send=80,
        doomed_evac_max_sources=2,
        doomed_evac_allow_own_target=True,
        doomed_evac_allow_attack_target=False,
        doomed_evac_own_target_bonus=28.0,
    ),
    "p2_doomed_evac_counter_s0_180_eta8": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=2,
        doomed_evac_max_active_players=2,
        ...
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=28.0,
        doomed_evac_enemy_target_bonus=26.0,
    ),
    "p4_doomed_evac_safe_s25_180_eta7": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        ...
        doomed_evac_max_arrival=7,
        doomed_evac_min_enemy_post_capture=5,
        doomed_evac_min_send=6,
        doomed_evac_max_send=70,
        doomed_evac_max_sources=2,
        doomed_evac_allow_own_target=True,
        doomed_evac_allow_attack_target=False,
        doomed_evac_own_target_bonus=30.0,
        doomed_evac_safe_enemy_radius=45.0,
    ),
    "p4_doomed_evac_mixed_s25_180_eta7": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_allow_own_target=True,
        doomed_evac_allow_attack_target=True,
        doomed_evac_own_target_bonus=22.0,
        doomed_evac_attack_target_bonus=20.0,
        doomed_evac_enemy_target_bonus=24.0,
        doomed_evac_safe_enemy_radius=45.0,
    ),
}

ABLATION_SUITES["myreplay_plan028_p4_doomed_evac_refine"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_evac_safe_eta2_5_prod2_post8_cap40": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        doomed_evac_min_step=35,
        doomed_evac_max_step=150,
        doomed_evac_min_production=2.0,
        doomed_evac_horizon=18,
        doomed_evac_min_arrival=2,
        doomed_evac_max_arrival=5,
        doomed_evac_min_enemy_post_capture=8,
        doomed_evac_min_send=8,
        doomed_evac_max_send=40,
        doomed_evac_max_sources=1,
        doomed_evac_allow_own_target=True,
        doomed_evac_allow_attack_target=False,
        doomed_evac_own_target_bonus=36.0,
        doomed_evac_safe_enemy_radius=48.0,
        doomed_evac_front_penalty=28.0,
    ),
    "p4_evac_safe_eta2_6_prod3_post10_cap45": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        doomed_evac_min_step=35,
        doomed_evac_max_step=150,
        doomed_evac_min_production=3.0,
        doomed_evac_horizon=20,
        doomed_evac_min_arrival=2,
        doomed_evac_max_arrival=6,
        doomed_evac_min_enemy_post_capture=10,
        doomed_evac_min_send=8,
        doomed_evac_max_send=45,
        doomed_evac_max_sources=1,
        doomed_evac_allow_own_target=True,
        doomed_evac_allow_attack_target=False,
        doomed_evac_own_target_bonus=40.0,
        doomed_evac_safe_enemy_radius=50.0,
        doomed_evac_front_penalty=30.0,
    ),
    "p4_counter_eta2_5_prod2_post8_cap45": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_allow_own_target=False,
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=30.0,
        doomed_evac_enemy_target_bonus=34.0,
        doomed_evac_target_prod_weight=10.0,
    ),
    "p4_counter_eta2_6_prod3_post10_cap50": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_allow_own_target=False,
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=34.0,
        doomed_evac_enemy_target_bonus=36.0,
        doomed_evac_target_prod_weight=10.0,
    ),
    "p4_counter_last_eta1_3_prod1_post12_cap35": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        doomed_evac_min_step=45,
        doomed_evac_max_step=160,
        doomed_evac_min_production=1.0,
        doomed_evac_horizon=12,
        doomed_evac_min_arrival=1,
        doomed_evac_max_arrival=3,
        doomed_evac_min_enemy_post_capture=12,
        doomed_evac_min_send=10,
        doomed_evac_max_send=35,
        doomed_evac_max_sources=1,
        doomed_evac_allow_own_target=False,
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=42.0,
        doomed_evac_enemy_target_bonus=44.0,
        doomed_evac_target_prod_weight=9.0,
    ),
    "p4_mixed_eta2_5_prod2_post8_cap40": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_allow_own_target=True,
        doomed_evac_allow_attack_target=True,
        doomed_evac_own_target_bonus=24.0,
        doomed_evac_attack_target_bonus=26.0,
        doomed_evac_enemy_target_bonus=32.0,
        doomed_evac_safe_enemy_radius=48.0,
        doomed_evac_front_penalty=28.0,
    ),
}

ABLATION_SUITES["myreplay_plan029_p4_doomed_counter_focus"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "counter_last_eta1_3_prod1_post12_cap35": ABLATION_SUITES[
        "myreplay_plan028_p4_doomed_evac_refine"
    ]["p4_counter_last_eta1_3_prod1_post12_cap35"],
    "counter_last_eta1_3_prod1_post16_cap30": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_min_arrival=1,
        doomed_evac_max_arrival=3,
        doomed_evac_min_enemy_post_capture=16,
        doomed_evac_min_send=10,
        doomed_evac_max_send=30,
        doomed_evac_max_sources=1,
        doomed_evac_allow_own_target=False,
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=46.0,
        doomed_evac_enemy_target_bonus=48.0,
        doomed_evac_target_prod_weight=9.0,
    ),
    "counter_last_eta1_3_prod1_post16_cap45": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
    ...
    "counter_last_eta1_4_prod1_post14_cap35": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_max_step=160,
        doomed_evac_min_production=1.0,
        doomed_evac_horizon=14,
        doomed_evac_min_arrival=1,
        doomed_evac_max_arrival=4,
        doomed_evac_min_enemy_post_capture=14,
        doomed_evac_min_send=10,
        doomed_evac_max_send=35,
        doomed_evac_max_sources=1,
        doomed_evac_allow_own_target=False,
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=44.0,
        doomed_evac_enemy_target_bonus=46.0,
        doomed_evac_target_prod_weight=9.0,
    ),
    "counter_mid_eta2_5_prod2_post12_cap35": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        doomed_evac_min_step=40,
        doomed_evac_max_step=150,
        doomed_evac_min_production=2.0,
        doomed_evac_horizon=18,
        doomed_evac_min_arrival=2,
        ...
        doomed_evac_allow_own_target=False,
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=38.0,
        doomed_evac_enemy_target_bonus=40.0,
        doomed_evac_target_prod_weight=10.0,
    ),
}

ABLATION_SUITES["myreplay_plan030_p4_doomed_counter_top_confirm"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "counter_last_eta1_3_prod1_post12_cap35": ABLATION_SUITES[
        "myreplay_plan029_p4_doomed_counter_focus"
    ]["counter_last_eta1_3_prod1_post12_cap35"],
    "counter_last_eta1_3_prod1_post16_cap30": ABLATION_SUITES[
        "myreplay_plan029_p4_doomed_counter_focus"
    ]["counter_last_eta1_3_prod1_post16_cap30"],
    "counter_last_eta1_4_prod1_post14_cap35": ABLATION_SUITES[
        "myreplay_plan029_p4_doomed_counter_focus"
    ]["counter_last_eta1_4_prod1_post14_cap35"],
}

ABLATION_SUITES["myreplay_plan031_p4_doomed_counter_pair_confirm"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "counter_last_eta1_3_prod1_post12_cap35": ABLATION_SUITES[
        "myreplay_plan029_p4_doomed_counter_focus"
    ]["counter_last_eta1_3_prod1_post12_cap35"],
...
ABLATION_SUITES["myreplay_plan032_p4_doomed_counter_post16_pair"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "counter_last_eta1_3_prod1_post16_cap30": ABLATION_SUITES[
        "myreplay_plan029_p4_doomed_counter_focus"
    ]["counter_last_eta1_3_prod1_post16_cap30"],
...
ABLATION_SUITES["myreplay_plan033_p4_doomed_counter_eta4_pair"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "counter_last_eta1_4_prod1_post14_cap35": ABLATION_SUITES[
        "myreplay_plan029_p4_doomed_counter_focus"
    ]["counter_last_eta1_4_prod1_post14_cap35"],
...
ABLATION_SUITES["myreplay_plan034_p4_doomed_counter_tail_filter"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "tail_enemy_prod3_eta18_post1_s20_120": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        doomed_evac_min_step=20,
        doomed_evac_max_step=120,
        doomed_evac_min_production=1.0,
        doomed_evac_horizon=30,
        doomed_evac_min_arrival=1,
        doomed_evac_max_arrival=10,
        doomed_evac_min_enemy_post_capture=1,
        doomed_evac_min_send=5,
        doomed_evac_max_send=42,
        doomed_evac_max_sources=1,
        doomed_evac_allow_own_target=False,
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=48.0,
        doomed_evac_enemy_target_bonus=60.0,
        doomed_evac_target_prod_weight=12.0,
        doomed_evac_attack_max_arrival=18,
        doomed_evac_attack_min_production=3.0,
        doomed_evac_attack_enemy_only=True,
        doomed_evac_attack_min_net_value=40.0,
    ),
    "tail_enemy_prod4_eta16_post1_s20_120": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_min_enemy_post_capture=1,
        doomed_evac_min_send=6,
        doomed_evac_max_send=38,
        doomed_evac_max_sources=1,
        doomed_evac_allow_own_target=False,
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=52.0,
        doomed_evac_enemy_target_bonus=65.0,
        doomed_evac_target_prod_weight=14.0,
        doomed_evac_attack_max_arrival=16,
        doomed_evac_attack_min_production=4.0,
        doomed_evac_attack_enemy_only=True,
        doomed_evac_attack_min_net_value=60.0,
    ),
    "tail_any_prod4_eta14_post4_s35_150": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_max_step=150,
        doomed_evac_min_production=1.0,
        doomed_evac_horizon=22,
        doomed_evac_min_arrival=1,
        doomed_evac_max_arrival=6,
        doomed_evac_min_enemy_post_capture=4,
        doomed_evac_min_send=8,
        doomed_evac_max_send=34,
        doomed_evac_max_sources=1,
        doomed_evac_allow_own_target=False,
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=44.0,
        doomed_evac_enemy_target_bonus=45.0,
        doomed_evac_target_prod_weight=14.0,
        doomed_evac_attack_max_arrival=14,
        doomed_evac_attack_min_production=4.0,
        doomed_evac_attack_enemy_only=False,
        doomed_evac_attack_min_net_value=70.0,
    ),
}

ABLATION_SUITES["myreplay_plan035_p4_doomed_counter_relaxed_tail"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "tail_enemy_prod2_eta22_post1_s15_140": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        doomed_evac_min_step=15,
        doomed_evac_max_step=140,
        doomed_evac_min_production=1.0,
        doomed_evac_horizon=36,
        doomed_evac_min_arrival=1,
        doomed_evac_max_arrival=12,
        doomed_evac_min_enemy_post_capture=1,
        doomed_evac_min_send=4,
        doomed_evac_max_send=44,
        doomed_evac_max_sources=1,
        doomed_evac_allow_own_target=False,
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=46.0,
        doomed_evac_enemy_target_bonus=58.0,
        doomed_evac_target_prod_weight=11.0,
        doomed_evac_attack_max_arrival=22,
        doomed_evac_attack_min_production=2.0,
        doomed_evac_attack_enemy_only=True,
        doomed_evac_attack_min_net_value=15.0,
    ),
    "tail_any_prod3_eta20_post1_s15_140": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=42.0,
        doomed_evac_enemy_target_bonus=50.0,
        doomed_evac_target_prod_weight=12.0,
        doomed_evac_attack_max_arrival=20,
        doomed_evac_attack_min_production=3.0,
        doomed_evac_attack_enemy_only=False,
        doomed_evac_attack_min_net_value=25.0,
    ),
    "tail_enemy_prod2_eta18_post4_s25_160": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=48.0,
        doomed_evac_enemy_target_bonus=62.0,
        doomed_evac_target_prod_weight=11.0,
        doomed_evac_attack_max_arrival=18,
        doomed_evac_attack_min_production=2.0,
        doomed_evac_attack_enemy_only=True,
        doomed_evac_attack_min_net_value=20.0,
    ),
}

ABLATION_SUITES["myreplay_plan036_p4_doomed_counter_pair_relaxed"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "tail_enemy_prod2_eta22_post1_s15_140": ABLATION_SUITES[
        "myreplay_plan035_p4_doomed_counter_relaxed_tail"
    ]["tail_enemy_prod2_eta22_post1_s15_140"],
}

ABLATION_SUITES["myreplay_plan037_p4_doomed_counter_source_focus"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "source_only_enemy_prod1_eta24_post1_s15_160": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_allow_own_target=False,
        doomed_evac_allow_attack_target=True,
        doomed_evac_attack_target_bonus=25.0,
        doomed_evac_enemy_target_bonus=40.0,
        doomed_evac_target_prod_weight=10.0,
        doomed_evac_attack_max_arrival=24,
        doomed_evac_attack_min_production=1.0,
        doomed_evac_attack_enemy_only=True,
        doomed_evac_attack_min_net_value=-10.0,
        doomed_evac_attack_source_only=True,
        doomed_evac_attack_source_bonus=80.0,
    ),
    "source_bonus_enemy_prod1_eta24_post1_s15_160": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_attack_enemy_only=True,
        doomed_evac_attack_min_net_value=-10.0,
        doomed_evac_attack_source_only=False,
        doomed_evac_attack_source_bonus=90.0,
    ),
    "source_only_enemy_prod2_eta20_post4_s25_170": from_base(
        REGULAR_CONFIG,
        enable_doomed_planet_evacuation=True,
        doomed_evac_min_active_players=4,
        doomed_evac_max_active_players=4,
        ...
        doomed_evac_attack_min_production=2.0,
        doomed_evac_attack_enemy_only=True,
        doomed_evac_attack_min_net_value=5.0,
        doomed_evac_attack_source_only=True,
        doomed_evac_attack_source_bonus=85.0,
    ),
}

ABLATION_SUITES["myreplay_plan038_p4_doomed_counter_source_pair"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "source_bonus_enemy_prod1_eta24_post1_s15_160": ABLATION_SUITES[
...
ABLATION_SUITES["myreplay_plan028_p4_mid_border_top_confirm"] = {
    ...
    "p4_mid_border_prod2_s40_150_m5": ABLATION_SUITES["myreplay_plan027_p4_mid_border_confirm"][
        "p4_mid_border_prod2_s40_150_m5"
    ],
}
...
ABLATION_SUITES["myreplay_plan020_leader_pressure_focus"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "leader_pressure_125": ABLATION_SUITES["myreplay_plan020_regular_counter_refine"]["leader_pressure_125"],
    "leader_pressure_150": ABLATION_SUITES["myreplay_plan020_regular_counter_refine"]["leader_pressure_150"],
    "leader_pressure_175": ABLATION_SUITES["myreplay_plan020_regular_counter_refine"]["leader_pressure_175"],
}

ABLATION_SUITES["unread260519_plan032_p4_throughput_counter"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_no_early_source_filter": from_base(
        REGULAR_CONFIG,
        enable_source_threat_send_filter=False,
    ),
    "p4_short_source_filter_s35_60": from_base(
        REGULAR_CONFIG,
        source_threat_send_max_step=60,
    ),
    "p4_no_attack_fallback_c6_s25_150": from_base(
        REGULAR_CONFIG,
        enable_no_attack_fallback=True,
        no_attack_fallback_min_active_players=4,
        no_attack_fallback_max_active_players=4,
        no_attack_fallback_min_step=25,
        no_attack_fallback_max_step=150,
        no_attack_fallback_candidate_limit=6,
        no_attack_fallback_min_attack_delta=-1,
    ),
    "p4_tail_inject_limit1_score52": from_base(
        REGULAR_CONFIG,
        enable_third_party_tail_candidate_injection=True,
        third_party_tail_candidate_limit=1,
        third_party_tail_candidate_min_score=52.0,
    ...
    "p4_throughput_tail_no_filter": from_base(
        REGULAR_CONFIG,
        enable_source_threat_send_filter=False,
        enable_no_attack_fallback=True,
        no_attack_fallback_min_active_players=4,
...
ABLATION_SUITES["unread260519_plan033_p2_wave_hold_counter"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p2_wave_prod3_h40_post45_m12": from_base(
        REGULAR_CONFIG,
        enable_enemy_wave_preserve_prod=True,
        enemy_wave_preserve_min_active_players=2,
        enemy_wave_preserve_max_active_players=2,
    ...
    "p2_wave_prod4_h45_post60_m14": from_base(
        REGULAR_CONFIG,
        enable_enemy_wave_preserve_prod=True,
        enemy_wave_preserve_min_active_players=2,
        enemy_wave_preserve_max_active_players=2,
    ...
    "p2_dynamic_recap_prod2_b35": from_base(
        REGULAR_CONFIG,
        enable_dynamic_front_base_recapture=True,
        dynamic_recapture_min_production=2.0,
        dynamic_recapture_enable_2p=True,
    ...
    "p2_wave_plus_recap_prod2": from_base(
        REGULAR_CONFIG,
        enable_enemy_wave_preserve_prod=True,
        enemy_wave_preserve_min_active_players=2,
        enemy_wave_preserve_max_active_players=2,
...
ABLATION_SUITES["unread260519_plan034_vadasz_imitation_combo"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p4_chain_src3_relaxed": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_chain_attack=True,
        chain_attack_min_active_players=4,
        chain_attack_max_active_players=4,
    ...
    "p4_chain_mobile_relay": from_base(
        REGULAR_CONFIG,
        enable_mobile_relay_attack=True,
        mobile_relay_min_active_players=4,
        mobile_relay_max_active_players=4,
    ...
    "p4_chain_tail_inject": from_base(
        REGULAR_CONFIG,
        enable_third_party_tail_candidate_injection=True,
        third_party_tail_candidate_limit=1,
        third_party_tail_candidate_min_score=52.0,
    ...
    "p4_vadasz_combo_relaxed_chain_tail": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_chain_attack=True,
        chain_attack_min_active_players=4,
        chain_attack_max_active_players=4,
    ...
    "p4_vadasz_combo_pressure": from_base(
        REGULAR_CONFIG,
        multiplayer_local_enemy_bonus=5.0,
        multiplayer_leader_prod_bonus=1.5,
        enable_third_party_tail_candidate_injection=True,
...
ABLATION_SUITES["myreplay_plan042_p2_recent_capture_activation"] = {
    "regular": REGULAR_CONFIG.to_agent_kwargs(),
    "p2_activation_prod3_s0_140_w24_eta28": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        activation_min_step=0,
        ...
        activation_target_min_production=2.0,
        activation_max_eta=28,
        activation_candidate_limit=4,
        activation_max_attacks_per_turn=1,
        activation_enemy_bonus=36.0,
        activation_neutral_bonus=18.0,
        activation_prod_weight=12.0,
        activation_eta_weight=0.75,
        activation_ship_weight=0.20,
        activation_direction_bonus=12.0,
    ),
    "p2_activation_prod3_frontbase_s0_150_w28_eta30": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        activation_min_step=0,
        activation_max_step=150,
        activation_source_window=28,
        activation_source_min_production=3.0,
        activation_enable_front_base_source=True,
        activation_front_base_max_production=2.0,
        activation_front_base_enemy_radius=45.0,
        activation_source_min_after=4,
        activation_source_prod_turns_after=1,
        activation_min_send=8,
        activation_max_send=52,
        activation_target_min_production=2.0,
        activation_max_eta=30,
        activation_candidate_limit=5,
        activation_max_attacks_per_turn=1,
        activation_enemy_bonus=34.0,
        activation_neutral_bonus=20.0,
        activation_prod_weight=11.0,
        activation_eta_weight=0.65,
        activation_ship_weight=0.16,
        activation_direction_bonus=10.0,
        activation_front_base_target_bonus=12.0,
    ),
    "p2_activation_aggr_prod2_s20_160_w20_eta24": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        activation_min_step=20,
        activation_max_step=160,
        activation_source_window=20,
        activation_source_min_production=2.0,
        activation_enable_front_base_source=True,
        activation_front_base_max_production=2.0,
        activation_front_base_enemy_radius=42.0,
        activation_source_min_after=3,
        activation_source_prod_turns_after=1,
        activation_min_send=7,
        activation_max_send=44,
        activation_target_min_production=1.0,
        activation_max_eta=24,
        activation_candidate_limit=5,
        activation_max_attacks_per_turn=2,
        activation_enemy_bonus=30.0,
        activation_neutral_bonus=14.0,
        activation_prod_weight=9.0,
        activation_eta_weight=0.80,
        activation_ship_weight=0.18,
        activation_direction_bonus=8.0,
        activation_front_base_target_bonus=14.0,
    ),
    "p2_activation_priority_prod3_s0_140_w24_eta28": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_enable_extra_attack=False,
        activation_enable_attack_priority=True,
        activation_attack_source_bonus=900.0,
        activation_attack_target_bonus=50.0,
        activation_min_active_players=2,
        activation_max_active_players=2,
        activation_min_step=0,
        activation_max_step=140,
    ...
    "p2_activation_priority_plus_extra_prod3": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_enable_extra_attack=True,
        activation_enable_attack_priority=True,
        activation_attack_source_bonus=750.0,
        activation_attack_target_bonus=35.0,
        activation_min_active_players=2,
        activation_max_active_players=2,
        activation_min_step=0,
        activation_max_step=140,
    ...
    "p2_activation_trickle_prod3_s0_120_w24_eta28": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_enable_extra_attack=False,
        activation_enable_trickle=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        activation_min_step=0,
        activation_max_step=120,
        activation_source_window=24,
        activation_source_min_production=3.0,
        activation_source_min_after=5,
        activation_source_prod_turns_after=1,
        activation_trickle_min_send=8,
        activation_trickle_max_send=28,
        activation_trickle_send_fraction=0.70,
        activation_target_min_production=2.0,
        activation_max_eta=28,
        activation_candidate_limit=4,
        activation_max_attacks_per_turn=1,
        activation_enemy_bonus=32.0,
        activation_neutral_bonus=24.0,
        activation_prod_weight=12.0,
        activation_eta_weight=0.70,
        activation_ship_weight=0.12,
        activation_direction_bonus=10.0,
    ),
    "p2_activation_trickle_prod3_s15_140_w20_eta24": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_enable_extra_attack=False,
        activation_enable_trickle=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        activation_min_step=15,
        activation_max_step=140,
        activation_source_window=20,
        activation_source_min_production=3.0,
        activation_source_min_after=6,
        activation_source_prod_turns_after=1,
        activation_trickle_min_send=10,
        activation_trickle_max_send=24,
        activation_trickle_send_fraction=0.60,
        activation_target_min_production=3.0,
        activation_max_eta=24,
        activation_candidate_limit=3,
        activation_max_attacks_per_turn=1,
        activation_enemy_bonus=36.0,
        activation_neutral_bonus=18.0,
        activation_prod_weight=13.0,
        activation_eta_weight=0.85,
        activation_ship_weight=0.14,
        activation_direction_bonus=8.0,
    ),
    "p2_activation_gate_even_prod3_s0_140": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        ...
        activation_ship_weight=0.20,
        activation_direction_bonus=12.0,
        activation_min_prod_diff=0.0,
        activation_min_ship_diff=-25.0,
        activation_min_planet_diff=0,
        activation_max_recent_highprod_losses=1,
    ),
    "p2_activation_gate_soft_prod3_s0_140": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        ...
        activation_ship_weight=0.20,
        activation_direction_bonus=12.0,
        activation_min_prod_diff=-2.0,
        activation_min_ship_diff=-50.0,
        activation_min_planet_diff=-1,
        activation_max_recent_highprod_losses=2,
    ),
    "p2_activation_late45_enemy_prod3_eta28": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        activation_min_step=45,
        activation_max_step=140,
        activation_source_window=24,
        activation_source_min_production=3.0,
        activation_source_min_after=5,
        ...
        activation_max_send=48,
        activation_target_min_production=3.0,
        activation_include_neutral_targets=False,
        activation_include_enemy_targets=True,
        activation_max_eta=28,
        activation_candidate_limit=4,
        activation_max_attacks_per_turn=1,
        activation_enemy_bonus=42.0,
        activation_neutral_bonus=0.0,
        activation_prod_weight=13.0,
        activation_eta_weight=0.75,
        activation_ship_weight=0.18,
        activation_direction_bonus=12.0,
    ),
    "p2_activation_late50_enemy_prod3_eta28": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
    ...
    "p2_activation_late50_mixed_prod3_eta28": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
    ...
    "p2_activation_enemy50_prod2_eta32_s2": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        activation_min_step=50,
        activation_max_step=120,
        activation_source_window=30,
        activation_source_min_production=3.0,
        activation_source_min_after=6,
        activation_source_prod_turns_after=1,
        activation_min_send=8,
        activation_max_send=56,
        activation_target_min_production=2.0,
        activation_include_neutral_targets=False,
        activation_include_enemy_targets=True,
        activation_max_eta=32,
        activation_candidate_limit=5,
        activation_max_attacks_per_turn=1,
        activation_enemy_bonus=52.0,
        activation_neutral_bonus=0.0,
        activation_prod_weight=10.0,
        activation_eta_weight=0.95,
        activation_ship_weight=0.16,
        activation_direction_bonus=12.0,
    ),
    "p2_activation_late50_mixed_prod3_ctx_even": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        ...
        activation_direction_bonus=12.0,
        activation_min_prod_diff=0.0,
        activation_min_ship_diff=-10.0,
        activation_min_planet_diff=0,
    ),
    "p2_activation_late50_mixed_prod3_ctx_soft": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        ...
        activation_ship_weight=0.18,
        activation_direction_bonus=12.0,
        activation_min_prod_diff=-1.0,
        activation_min_ship_diff=-30.0,
        activation_min_planet_diff=-1,
    ),
    "p2_activation_front_static_late50_prod3": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        ...
        activation_include_neutral_targets=True,
        activation_include_enemy_targets=True,
        activation_allow_moving_sources=False,
        activation_allow_static_sources=True,
        activation_allow_moving_targets=False,
        activation_allow_static_targets=True,
        activation_source_front_enemy_radius=58.0,
        activation_source_support_radius=45.0,
        activation_source_min_support_prod=3.0,
        activation_target_front_own_radius=58.0,
        activation_target_front_enemy_radius=58.0,
        activation_target_connector_bonus=18.0,
        activation_static_target_bonus=6.0,
        activation_moving_target_bonus=-8.0,
        activation_max_eta=28,
        activation_candidate_limit=4,
        activation_max_attacks_per_turn=1,
        activation_enemy_bonus=42.0,
        activation_neutral_bonus=6.0,
        activation_prod_weight=13.0,
        activation_eta_weight=0.75,
        activation_ship_weight=0.18,
        activation_direction_bonus=12.0,
    ),
    "p2_activation_front_any_late50_prod3": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        ...
        activation_include_neutral_targets=True,
        activation_include_enemy_targets=True,
        activation_allow_moving_sources=True,
        activation_allow_static_sources=True,
        activation_allow_moving_targets=True,
        activation_allow_static_targets=True,
        activation_source_front_enemy_radius=58.0,
        activation_source_support_radius=45.0,
        activation_source_min_support_prod=3.0,
        ...
        activation_target_front_enemy_radius=58.0,
        activation_target_connector_bonus=18.0,
        activation_static_target_bonus=4.0,
        activation_moving_target_bonus=2.0,
        activation_max_eta=28,
        activation_candidate_limit=4,
        activation_max_attacks_per_turn=1,
        activation_enemy_bonus=42.0,
    ...
    "p2_activation_moving_target_late45_enemy": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        activation_min_step=45,
        activation_max_step=130,
        activation_source_window=28,
        activation_source_min_production=3.0,
        activation_source_min_after=6,
        activation_source_prod_turns_after=1,
        ...
        activation_allow_static_sources=True,
        activation_allow_moving_targets=True,
        activation_allow_static_targets=False,
        activation_source_front_enemy_radius=65.0,
        activation_target_front_own_radius=70.0,
        activation_target_connector_bonus=10.0,
        activation_moving_target_bonus=18.0,
        activation_max_eta=34,
        activation_candidate_limit=5,
        activation_max_attacks_per_turn=1,
        activation_enemy_bonus=48.0,
        activation_neutral_bonus=0.0,
        activation_prod_weight=10.0,
        activation_eta_weight=0.90,
        activation_ship_weight=0.16,
        activation_direction_bonus=10.0,
    ),
    "p2_activation_front_any_ctxlead_prod3": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        ...
        activation_target_connector_bonus=18.0,
        activation_static_target_bonus=4.0,
        activation_moving_target_bonus=0.0,
        activation_max_eta=28,
        activation_candidate_limit=4,
        activation_max_attacks_per_turn=1,
        activation_enemy_bonus=42.0,
        ...
        activation_direction_bonus=12.0,
        activation_min_prod_diff=2.0,
        activation_min_ship_diff=20.0,
        activation_min_planet_diff=0,
    ),
    "p2_activation_mixed_ctxlead_prod3": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
    ...
    "p2_activation_front_any_nobase_prod3": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
        ...
        activation_candidate_limit=4,
        activation_max_attacks_per_turn=1,
        activation_base_target_score_weight=0.0,
        activation_enemy_bonus=42.0,
        activation_neutral_bonus=6.0,
        activation_prod_weight=13.0,
        activation_eta_weight=0.75,
    ...
    "p2_activation_mixed_nobase_prod3": from_base(
        REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_min_active_players=2,
        activation_max_active_players=2,
