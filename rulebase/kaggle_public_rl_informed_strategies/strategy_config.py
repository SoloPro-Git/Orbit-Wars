...
ABLATION_SUITES["bowwow_plan050_lowconn_2p_window"] = {
    "p2_enemyhp_latest": TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG.to_agent_kwargs(),
    "lowconn_2to4_existing_b10_eta18": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        low_prod_connector_min_active_players=2,
        low_prod_connector_max_active_players=4,
    ),
    "lowconn_2to4_early_b8_enemy10_eta14": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        low_prod_connector_min_active_players=2,
        low_prod_connector_max_active_players=4,
        low_prod_connector_min_step=0,
        low_prod_connector_max_step=130,
        low_prod_connector_bonus=8.0,
        low_prod_connector_enemy_bonus=10.0,
        low_prod_connector_max_eta=14,
        low_prod_connector_eta_penalty=1.0,
    ),
    "lowconn_2to4_late_b12_enemy12_eta18": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        low_prod_connector_min_active_players=2,
        low_prod_connector_max_active_players=4,
        low_prod_connector_min_step=40,
        low_prod_connector_max_step=160,
        low_prod_connector_bonus=12.0,
        low_prod_connector_enemy_bonus=12.0,
        low_prod_connector_max_eta=18,
        low_prod_connector_eta_penalty=1.0,
    ),
    "lowconn_2to4_late_b16_enemy8_eta22": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        low_prod_connector_min_active_players=2,
        low_prod_connector_max_active_players=4,
        low_prod_connector_min_step=45,
        low_prod_connector_max_step=170,
        low_prod_connector_bonus=16.0,
        low_prod_connector_enemy_bonus=8.0,
        low_prod_connector_max_eta=22,
        low_prod_connector_eta_penalty=0.8,
...
ABLATION_SUITES["bowwow_plan051_lowprod_front_activation"] = {
    "p2_enemyhp_latest": TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG.to_agent_kwargs(),
    "frontbase_lowprod_extra_eta18": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_enable_extra_attack=True,
        activation_enable_trickle=False,
        activation_min_active_players=2,
        activation_max_active_players=2,
        activation_min_step=45,
        activation_max_step=170,
        activation_source_window=34,
        activation_source_min_production=4.0,
        activation_enable_front_base_source=True,
        activation_front_base_max_production=2.0,
        activation_front_base_enemy_radius=48.0,
        activation_source_min_after=5,
        activation_source_prod_turns_after=1,
        activation_min_send=6,
        activation_max_send=44,
        activation_target_min_production=1.0,
        activation_include_neutral_targets=True,
        activation_include_enemy_targets=True,
        activation_target_front_own_radius=48.0,
        activation_target_front_enemy_radius=58.0,
        activation_target_connector_bonus=32.0,
        activation_static_target_bonus=3.0,
        activation_moving_target_bonus=8.0,
        activation_max_eta=18,
        activation_candidate_limit=4,
        activation_max_attacks_per_turn=1,
        activation_base_target_score_weight=0.10,
        activation_enemy_bonus=28.0,
        activation_neutral_bonus=16.0,
        activation_prod_weight=4.0,
        activation_eta_weight=0.9,
        activation_ship_weight=0.16,
        activation_direction_bonus=6.0,
        activation_front_base_target_bonus=18.0,
    ),
    "frontbase_lowprod_extra_eta14_tight": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_enable_extra_attack=True,
        activation_enable_trickle=False,
        ...
        activation_source_prod_turns_after=1,
        activation_min_send=8,
        activation_max_send=38,
        activation_target_min_production=1.0,
        activation_include_neutral_targets=True,
        activation_include_enemy_targets=True,
        activation_target_front_own_radius=42.0,
        activation_target_front_enemy_radius=52.0,
        activation_target_connector_bonus=40.0,
        activation_static_target_bonus=2.0,
        activation_moving_target_bonus=6.0,
        activation_max_eta=14,
        activation_candidate_limit=3,
        activation_max_attacks_per_turn=1,
        activation_base_target_score_weight=0.05,
        activation_enemy_bonus=32.0,
        activation_neutral_bonus=14.0,
        activation_prod_weight=3.0,
        activation_eta_weight=1.1,
        activation_ship_weight=0.18,
        activation_direction_bonus=4.0,
        activation_front_base_target_bonus=20.0,
    ),
    "frontbase_lowprod_trickle_eta18": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enable_recent_capture_activation=True,
        activation_enable_extra_attack=False,
        activation_enable_trickle=True,
        ...
        activation_trickle_min_send=8,
        activation_trickle_max_send=28,
        activation_trickle_send_fraction=0.65,
        activation_target_min_production=1.0,
        activation_include_neutral_targets=True,
        activation_include_enemy_targets=True,
        activation_target_front_own_radius=48.0,
        activation_target_front_enemy_radius=58.0,
        activation_target_connector_bonus=36.0,
        activation_static_target_bonus=3.0,
        activation_moving_target_bonus=8.0,
        activation_max_eta=18,
        activation_candidate_limit=4,
...
ABLATION_SUITES["bowwow_plan052_opening_prod_tempo"] = {
    "p2_enemyhp_latest": TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG.to_agent_kwargs(),
    "p2_opening_tempo_prod3_s45_ship20_eta30": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enable_opening_tempo_neutral_fallback=True,
        opening_tempo_min_active_players=2,
        opening_tempo_max_active_players=2,
    ...
    "p2_opening_tempo_after_prod3_s45_ship20_eta30": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enable_opening_tempo_neutral_fallback=True,
        opening_tempo_allow_after_attack=True,
        opening_tempo_min_active_players=2,
    ...
    "p2_seed_neutral_prod4_s0_45_eta28": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enable_high_prod_capture_seed=True,
        capture_seed_min_active_players=2,
        capture_seed_max_active_players=2,
    ...
    "p2_seed_neutral_prod3_s0_60_eta32": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enable_high_prod_capture_seed=True,
        capture_seed_min_active_players=2,
        capture_seed_max_active_players=2,
...
ABLATION_SUITES["bowwow_plan053_4p_midgame_pressure_release"] = {
    "p2_enemyhp_latest": TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG.to_agent_kwargs(),
    "p4_no_home_anchor_reserve": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enable_home_anchor_source_reserve=False,
    ),
    "p4_source_filter_end60": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        source_threat_send_max_step=60,
    ),
    "p4_source_filter_softer": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        source_threat_send_min_production=4.0,
        source_threat_send_radius=40.0,
        source_threat_send_margin=3,
        source_threat_send_roi_multiplier=1.25,
        source_threat_send_min_net_value=20.0,
        source_threat_send_trade_ratio=1.05,
    ),
    "p4_source_filter_off": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enable_source_threat_send_filter=False,
    ),
}

ABLATION_SUITES["bowwow_plan054_4p_enemy_highprod_pressure"] = {
    "p2_enemyhp_latest": TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG.to_agent_kwargs(),
    "p4_enemyhp_s60_150_eta18_b6": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enemy_high_prod_pressure_min_active_players=3,
        enemy_high_prod_pressure_max_active_players=4,
        enemy_high_prod_pressure_min_step=60,
        enemy_high_prod_pressure_max_step=150,
        enemy_high_prod_pressure_min_production=3.0,
        enemy_high_prod_pressure_max_ships=52,
        enemy_high_prod_pressure_max_eta=18,
        enemy_high_prod_pressure_bonus=6.0,
        enemy_high_prod_pressure_prod_weight=4.5,
        enemy_high_prod_pressure_ship_weight=0.12,
        enemy_high_prod_pressure_eta_weight=0.55,
    ),
    "p4_enemyhp_s70_170_eta16_prod4": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enemy_high_prod_pressure_min_active_players=3,
        enemy_high_prod_pressure_max_active_players=4,
        enemy_high_prod_pressure_min_step=70,
        enemy_high_prod_pressure_max_step=170,
        enemy_high_prod_pressure_min_production=4.0,
        enemy_high_prod_pressure_max_ships=58,
        enemy_high_prod_pressure_max_eta=16,
        enemy_high_prod_pressure_bonus=8.0,
        enemy_high_prod_pressure_prod_weight=5.5,
        enemy_high_prod_pressure_ship_weight=0.10,
        enemy_high_prod_pressure_eta_weight=0.70,
    ),
    "p4_enemyhp_s45_130_eta24_light": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enemy_high_prod_pressure_min_active_players=3,
        enemy_high_prod_pressure_max_active_players=4,
        enemy_high_prod_pressure_min_step=45,
        ...
        enemy_high_prod_pressure_max_ships=70,
        enemy_high_prod_pressure_max_eta=24,
        enemy_high_prod_pressure_bonus=4.0,
        enemy_high_prod_pressure_prod_weight=3.0,
        enemy_high_prod_pressure_ship_weight=0.08,
        enemy_high_prod_pressure_eta_weight=0.35,
    ),
    "p4_enemyhp_s85_190_eta14_strict": from_base(
        TAIL_M2_MAX12_NET7_OVERPAY4_P4LOWHOME_ACTIVE4_P4SEED_PROD4_P2MOVE10ETA16_STATIC2_P4LOWCONN10ETA18_P2ENEMYHPETA24_REGULAR_CONFIG,
        enemy_high_prod_pressure_min_active_players=3,
        enemy_high_prod_pressure_max_active_players=4,
        enemy_high_prod_pressure_min_step=85,
        enemy_high_prod_pressure_max_step=190,
        enemy_high_prod_pressure_min_production=4.0,
        enemy_high_prod_pressure_max_ships=48,
        enemy_high_prod_pressure_max_eta=14,
        enemy_high_prod_pressure_bonus=12.0,
        enemy_high_prod_pressure_prod_weight=6.0,
        enemy_high_prod_pressure_ship_weight=0.14,
        enemy_high_prod_pressure_eta_weight=0.90,
    ),
}

ABLATION_SUITES["bowwow_plan055_4p_enemy_highprod_strict_confirm"] = {
    "p2_enemyhp_latest": ABLATION_SUITES["bowwow_plan054_4p_enemy_highprod_pressure"][
        "p2_enemyhp_latest"
    ],
    "p4_enemyhp_s85_190_eta14_strict": ABLATION_SUITES[
        "bowwow_plan054_4p_enemy_highprod_pressure"
    ]["p4_enemyhp_s85_190_eta14_strict"],
}
