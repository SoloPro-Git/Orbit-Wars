...
- Config name:
  `mp_local3_neu5_comet12_path4p_hold4_terr30_s35_home6_posthold_recap_b35_p4src_w002_lead10_p4earlysrc_s35_80_t120_regular`
- Alias: `regular`
- Packaged submission alias:
  `orbit_wars_regular_p4src_w002_lead10_p4earlysrc_s35_80_t120_slim_20260518`
...
- Why this matters: the previous recapture champion, source-risk champion, and
  leader-containment champion are kept under their own historical names, while
  `regular` now uses the validated early 4P source-protection improvement.
- Validation:
...
Current regular candidate under test:

- Config name: `tail_m2_max14_net7_regular_candidate`
- Base: `mp_local3_neu5_comet12_path4p_hold4_terr30_s35_home6_posthold_recap_b35_p4src_w002_lead10_regular`
- Change: enables conservative third-party tail capture with a watchlist,
  without candidate injection. It uses `third_party_tail_margin=2`,
  `third_party_tail_max_ships=14`, and `third_party_tail_min_net_value=7.0`.
  This candidate is intentionally not promoted to `REGULAR_CONFIG` yet; keep
  the 20260517 regular as the historical best until broader validation says
  otherwise.
